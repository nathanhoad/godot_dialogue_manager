...
const DialoguePropertyEditorControl = preload("res://addons/dialogue_manager/components/editor_property/editor_property_control.tscn")
...
func _init(_editor_plugin: EditorPlugin) -> void:
	editor_plugin = _editor_plugin
	
	add_child(control)
	
	control.editor_plugin = editor_plugin
