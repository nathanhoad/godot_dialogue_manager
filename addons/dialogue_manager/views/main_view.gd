...
func apply_theme() -> void:
	if is_instance_valid(plugin) and is_instance_valid(code_edit):
		...
		code_edit.theme_overrides = {
			...
			background_color = editor_settings.get_setting("interface/theme/base_color").blend(editor_settings.get_setting("text_editor/theme/highlighting/background_color")),
